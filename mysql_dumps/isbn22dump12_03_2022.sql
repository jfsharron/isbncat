...
--
-- Temporary view structure for view `2091View`
--

DROP TABLE IF EXISTS `2091View`;
/*!50001 DROP VIEW IF EXISTS `2091View`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `2091View` AS SELECT 
 1 AS `isbn_id`,
 1 AS `isbn`,
 1 AS `year`,
 1 AS `publisher`,
...
--
-- Temporary view structure for view `2092View`
--

DROP TABLE IF EXISTS `2092View`;
/*!50001 DROP VIEW IF EXISTS `2092View`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `2092View` AS SELECT 
 1 AS `isbn`,
 1 AS `year`,
 1 AS `publisher`,
 1 AS `author`,
...
) ENGINE=InnoDB AUTO_INCREMENT=2093 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cQuery` VALUES (2091,'2091','testing parameters','1','SELECT * FROM isbn WHERE year = 0000','SELECT * FROM 2091View','jfsharron','2022-11-28',1),(2092,'2092','general list of all isbn\'s','3','SELECT isbn, year, publisher, author, title, description FROM isbn a INNER JOIN genre b ON a.genre = b.value','SELECT * FROM 2092View','jfsharron','2022-12-03',0);
...
INSERT INTO `cqType` VALUES (2,'1','test','testing query'),(3,'2','search','search query'),(4,'3','list','general list of records');
/*!40000 ALTER TABLE `cqType` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `cqTypeView`
--

DROP TABLE IF EXISTS `cqTypeView`;
/*!50001 DROP VIEW IF EXISTS `cqTypeView`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `cqTypeView` AS SELECT 
 1 AS `value`,
 1 AS `name`,
 1 AS `description`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `listAll`
--

DROP TABLE IF EXISTS `listAll`;
/*!50001 DROP VIEW IF EXISTS `listAll`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `listAll` AS SELECT 
 1 AS `isbn`,
 1 AS `year`,
 1 AS `publisher`,
 1 AS `author`,
...
--
-- Final view structure for view `2091View`
--
...
/*!50013 DEFINER=`jfsharron`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `2091View` AS select `isbn`.`isbn_id` AS `isbn_id`,`isbn`.`isbn` AS `isbn`,`isbn`.`year` AS `year`,`isbn`.`publisher` AS `publisher`,`isbn`.`author` AS `author`,`isbn`.`title` AS `title`,`isbn`.`genre` AS `genre` from `isbn` where (`isbn`.`year` = 2014) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `2092View`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`jfsharron`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `2092View` AS select `a`.`isbn` AS `isbn`,`a`.`year` AS `year`,`a`.`publisher` AS `publisher`,`a`.`author` AS `author`,`a`.`title` AS `title`,`b`.`description` AS `description` from (`isbn` `a` join `genre` `b` on((`a`.`genre` = `b`.`value`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `cqTypeView`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`jfsharron`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `cqTypeView` AS select `cqType`.`cqType_value` AS `value`,`cqType`.`cqType_name` AS `name`,`cqType`.`cqType_desc` AS `description` from `cqType` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `listAll`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`jfsharron`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `listAll` AS select `a`.`isbn` AS `isbn`,`a`.`year` AS `year`,`a`.`publisher` AS `publisher`,`a`.`author` AS `author`,`a`.`title` AS `title`,`b`.`description` AS `description` from (`isbn` `a` join `genre` `b` on((`a`.`genre` = `b`.`value`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-12-03 16:25:24
